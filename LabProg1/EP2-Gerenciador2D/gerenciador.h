 ...
 * do cálculo do diretório absoluto.
 *
 * A função tem comportamento similar a obterDirAbsoluto com a diferença que não é
 * utilizada a função realpath(). Se dest for um caminho absoluto o programa apenas
 * copiará os conteúdos de dest para destino e retornará 1. Caso contrário concatenará
 * base com dest, gravará os resultados em caminho e retornará 1.
 */
int gerarCaminhoDir(char *base, char *dest, char *caminho);
