...
public:
	 ...
	 */
	int inserir(Tipo info, unsigned int posicao);
	/**
	 ...
	 */
	int remover(unsigned int posicao);
	/**
	 ...
	 */
	int obter(Tipo info, Tipo *resultado);
